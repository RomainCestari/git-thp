...
def jl
  puts "Il y a #{@journalists_list.size} journalistes"
end

jl


def journalists_with_numbers
	...
	@journalists_list.each do |journalist|
		...
		journalist.each_byte do |character|
			result = Integer(character.chr) rescue false
		...
		if number_string == true
		x = x + 1
		end

		end

	puts "Il y a #{x} handles contenant des chiffres"

end

journalists_with_numbers
...
puts "Il y a #{x} handles contenant les 4 lettres du prénom Aude"
return x 
